...
class UserList
{
  ...
  insertUser(Username,Password)
  {
    ...
    let user = [user.getname(), user.getPassword()];

    db.run('CREATE TABLE IF NOT EXISTS \'user\' (username varchar(20) NOT NULL, password varchar(20) NOT NULL, PRIMARY KEY (\'username\') )')
